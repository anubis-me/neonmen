/*
 ...
 MyFonts Webfont Build ID 2959425, 2015-01-25T15:53:20-0500
 ...
 Webfont: MeetMeInBrooklyn-Regular by Street Type
 URL: http://www.myfonts.com/fonts/street-type/meet-me-in-brooklyn/regular/
 Copyright: Copyright (c) 2013 by Street Type Foundry. All rights reserved.
 Licensed pageviews: 20,000


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2959425

 ? 2015 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2d2841";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"MeetMeInBrooklyn-Regular",url:wfpath+"2D2841_0"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+
